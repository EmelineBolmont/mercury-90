...
m_fct_a.xaxis.grid(True, which='major', color='#222222', linestyle='-')
m_fct_a.yaxis.grid(True, which='major', color='#222222', linestyle='-')
m_fct_a.xaxis.grid(True, which='minor', color='#888888', linestyle='-')
