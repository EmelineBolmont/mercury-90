...
tableau = open("scaleheight_profile.dat", 'r')
...
for ligne in tableau:
	...
	H.append(Hi) # scaleheight (in AU)
	h.append(hi) # aspect ratio h
tableau.close()
...
pl.ylabel(unicode("Scaleheight H [AU]",'utf-8'))
#~ pl.legend()
pl.grid(True)
...
pl.xlabel(unicode("a [UA]",'utf-8'))
pl.ylabel(unicode("aspect ratio h",'utf-8'))
pl.grid(True)
